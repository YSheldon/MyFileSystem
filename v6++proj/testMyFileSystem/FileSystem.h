...
public:
	/* static consts */
	static const int SUPER_BLOCK_SECTOR_NUMBER = 1;	/* 定义SuperBlock位于磁盘上的扇区号，占据200，201两个扇区。 */
	...
	static const int INODE_ZONE_SIZE = 822;		/* 磁盘上外存Inode区占据的扇区数 */

	static const int DATA_ZONE_START_SECTOR = 825;		/* 数据区的起始扇区号 */
