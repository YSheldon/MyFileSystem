...
namespace Build
{
    ...
    public class Superblock
    {
        ...
        public Superblock(Disk diskFile)
        {
            ...
            //_s_fsize = MachinePara.Cylinders * MachinePara.Heads * MachinePara.Spt;
            _s_fsize = MachinePara.Disk_Size;
            _s_nfree = 100;
            _s_free = new int[100];
            _s_ninode = 100;
        ...
        private void InitPadding()
        {
            ...
            _s_padding[1] = MachinePara.Disk_Size;
            //Inode区起始位置
            //_s_padding[2] = MachinePara.SuperBlockSize + MachinePara.BootAndKernelSize;
            _s_padding[2] = MachinePara.SuperBlockSize + MachinePara.Boot_Size;
            //Inode区大小
            ...
            _s_padding[5] = _s_padding[1] - _s_padding[4];
            //Swap区起始位置
        ...
        public void UpdateSuperBlockToDisk()
        {
            ...
            _diskFile.SeekFilePosition(MachinePara.Boot_Size * 512, System.IO.SeekOrigin.Begin);
