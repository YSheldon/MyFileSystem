...
namespace Build
{
    class Run
    {
        ...
        private void ConstructDirectoryStruct()
        {
            ...
            DirFile homeDir = new DirFile(_superBlock, _inodeBlock, _dataBlock, _disk, "/home");
            homeDir.CreateDirectory();

            DirFile usrDir = new DirFile(_superBlock, _inodeBlock, _dataBlock, _disk, "/usr");
            usrDir.CreateDirectory();
