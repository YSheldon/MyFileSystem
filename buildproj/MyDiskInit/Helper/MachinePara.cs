...
namespace Build
{
    public class MachinePara
    {
        ...
        /// Disk的磁盘数
        /// </summary>
        public const int Disk_Size = 20160;
        /*
                /// <summary>
                /// 柱面数
                /// </summary>
        ...
        /// 超级块区的大小，单位是块（512B）
        /// </summary>
        public static int SuperBlockSize = 2;

        /// <summary>
        /// inode区的大小，单位是块（512B）
        /// </summary>
        public static int InodeSize = 822;
        ...
        */
        ...
        /// 磁盘文件路径
        /// </summary>
        public static string DiskPath = "MyDisk.img";
        ...
        ///初起块路径 
        /// </summary>
        public static string BootPath = "MyBoot.bin";
        ...
        */
        ...
        {
            return Disk_Size - Boot_Size - SuperBlockSize - InodeSize;
         }
        ...
        {
            return Boot_Size + SuperBlockSize + InodeSize;
        }
    }
}
